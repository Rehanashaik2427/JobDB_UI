          ...
          <Form className="job-posting-form" onSubmit={handleSubmit}>
            <div>
              ...
              <div className='job-details-row'>
                ...
                <Form.Group className='job-form-group'>
                  <Form.Label htmlFor="positions">Number of Positions:</Form.Label>
                  <Form.Control
                    type="number"
                    id="positions"
                ...
                <Form.Group className='job-form-group'>
                  <Form.Label htmlFor="deadline">Application Deadline:</Form.Label>
                  <Form.Control
                    type="date"
                    id="deadline"
                ...
                <Form.Group className='job-form-group'>
                  <Form.Label htmlFor="jobsummary">Job summary: Add Additional Information</Form.Label>
                  <Form.Control
                    as="textarea"
                    id="jobsummary"
                    name="jobsummary"
